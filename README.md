...
# Run unit tests (360 tests: hook payload formatting, HTTP parser, screen resolver, and more)
swift test
...
└── DynamicIslandCoreTests/         # 200 tests — HTTP framing, event decoding, login-item state
