...
# Run unit tests (423 tests: hook payload formatting, HTTP parser, screen resolver, and more)
swift test
...
└── DynamicIslandCoreTests/         # 255 tests — HTTP framing, event decoding, login-item state
```
